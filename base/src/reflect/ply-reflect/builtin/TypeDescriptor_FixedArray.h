...
extern TypeKey TypeKey_FixedArray;
...
struct TypeDescriptor_FixedArray : TypeDescriptor {
    ...
    TypeDescriptor_FixedArray(TypeDescriptor* item_type, u32 num_items)
    ...
    TypeDescriptor_FixedArray(TypeDescriptor* item_type, u32 num_items, u32 stride)
...
struct TypeDescriptorSpecializer<T[num_items]> {
    static TypeDescriptor_FixedArray* get() {
