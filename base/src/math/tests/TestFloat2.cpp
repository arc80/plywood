...
PLY_TEST_CASE("Float2 isNear") {
    PLY_TEST_CHECK(is_near(Float2{4}, Float2{4}, 1e-6f));
    PLY_TEST_CHECK(is_near(Float2{5}, Float2{5}, 0));
    PLY_TEST_CHECK(!is_near(Float2{5}, Float2{6}, 0));
    PLY_TEST_CHECK(is_near(Float2{1, 0}, Float2{0.9999f, 0.0001f}, 1e-3f));
    PLY_TEST_CHECK(!is_near(Float2{1, 0}, Float2{0.999f, 0.001f}, 1e-3f));
}
...
PLY_TEST_CASE("Float2 lengths") {
    ...
    PLY_TEST_CHECK(Float2{1, 0}.is_unit());
    PLY_TEST_CHECK(!Float2{1, 1}.is_unit());
    PLY_TEST_CHECK(Float2{999, 666}.normalized().is_unit());
    PLY_TEST_CHECK(Float2{0}.safe_normalized().is_unit());
}
...
PLY_TEST_CASE("Float2 clamp") {
    ...
    PLY_TEST_CHECK(clamp(Float2{3, 1.5f}, Float2{0, 1}, Float2{1, 2}) ==
                   Float2{1, 1.5f});
...
PLY_TEST_CASE("Float2 roundNearest") {
    PLY_TEST_CHECK(round_nearest(Float2{0.3f, 1.4f}, 2) == Float2{0, 2});
    PLY_TEST_CHECK(round_nearest(Float2{-0.3f, 1.4f}, 1) == Float2{0, 1});
    PLY_TEST_CHECK(round_nearest(Float2{0.3f, -1.4f}, 1) == Float2{0, -1});
    PLY_TEST_CHECK(round_nearest(Float2{-0.3f, 1.4f}, 0.5f) == Float2{-0.5f, 1.5f});
}

PLY_TEST_CASE("Float2 roundUp") {
    PLY_TEST_CHECK(round_up(Float2{0.3f, 1.4f}, 2) == Float2{2, 2});
    PLY_TEST_CHECK(round_up(Float2{-0.3f, 1.4f}, 1) == Float2{0, 2});
    PLY_TEST_CHECK(round_up(Float2{0.3f, -1.4f}, 1) == Float2{1, -1});
    PLY_TEST_CHECK(round_up(Float2{-0.3f, 1.4f}, 0.5f) == Float2{0, 1.5f});
}

PLY_TEST_CASE("Float2 roundDown") {
    PLY_TEST_CHECK(round_down(Float2{0.3f, 1.4f}, 2) == Float2{0, 0});
    PLY_TEST_CHECK(round_down(Float2{-0.3f, 1.4f}, 1) == Float2{-1, 1});
    PLY_TEST_CHECK(round_down(Float2{0.3f, -1.4f}, 1) == Float2{0, -2});
    PLY_TEST_CHECK(round_down(Float2{-0.3f, 1.4f}, 0.5f) == Float2{-0.5f, 1});
}

PLY_TEST_CASE("Float2 isRounded") {
    PLY_TEST_CHECK(is_rounded(Float2{0, 1}, 1));
    PLY_TEST_CHECK(!is_rounded(Float2{0.5f, 0}, 1));
    PLY_TEST_CHECK(!is_rounded(Float2{1, -0.5f}, 1));
    PLY_TEST_CHECK(is_rounded(Float2{0, 1}, 0.5f));
    PLY_TEST_CHECK(is_rounded(Float2{0.5f, -0.f}, 0.5f));
    PLY_TEST_CHECK(is_rounded(Float2{1, -0.5f}, 0.5f));
    PLY_TEST_CHECK(!is_rounded(Float2{-0.5f, 0.3f}, 0.5f));
    PLY_TEST_CHECK(!is_rounded(Float2{0, 1}, 2));
    PLY_TEST_CHECK(is_rounded(Float2{4, 8}, 2));
}
